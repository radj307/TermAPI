...
namespace sys::term {
	...
	inline constexpr const LineCharacter LineCharacter::CORNER_BOTTOM_RIGHT{ '\x6a' };
	/// ┐ Top-Right Corner Line
	inline constexpr const LineCharacter LineCharacter::CORNER_TOP_RIGHT{ '\x6b' };
	/// ┌ Top-Left Corner Line
	inline constexpr const LineCharacter LineCharacter::CORNER_TOP_LEFT{ '\x6c' };
	/// └ Bottom-Left Corner Line
	inline constexpr const LineCharacter LineCharacter::CORNER_BOTTOM_LEFT{ '\x6d' };
	/// ┼ 4-Way Cross Junction Line
	inline constexpr const LineCharacter LineCharacter::JUNCTION_4_WAY{ '\x6e' };
	/// ─ Horizontal Line
	inline constexpr const LineCharacter LineCharacter::LINE_HORIZONTAL{ '\x71' };
	/// ├ 3-Way Junction Line facing right (Missing line is facing left, so the junction is on the left side of the line drawing.)
	inline constexpr const LineCharacter LineCharacter::JUNCTION_3_WAY_LEFT{ '\x74' };
	/// ┤ 3-Way Junction Line facing left. (Missing line is facing right, so the junction is on the right side of the line drawing.)
	inline constexpr const LineCharacter LineCharacter::JUNCTION_3_WAY_RIGHT{ '\x75' };
	/// ┴ 3-Way Junction Line facing up. (Missing line is facing down, so the junction is on the bottom side of the line drawing.)
	inline constexpr const LineCharacter LineCharacter::JUNCTION_3_WAY_BOTTOM{ '\x76' };
	/// ┬ 3-Way Junction Line facing down. (Missing line is on the top, so the junction is on the top side of the line drawing.)
	inline constexpr const LineCharacter LineCharacter::JUNCTION_3_WAY_TOP{ '\x77' };
	/// │ Vertical Line
	inline constexpr const LineCharacter LineCharacter::LINE_VERTICAL{ '\x78' };
}